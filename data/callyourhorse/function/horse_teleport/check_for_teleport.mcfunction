...
function callyourhorse:goat_horn_give/check_horse_uuid_match_horn_uuid with storage callyourhorse:root
...
execute if score &UUID_check check.callyourhorse matches 0 run function callyourhorse:horse_teleport/get_latest_position with storage callyourhorse:root
...
execute if score &UUID_check check.callyourhorse matches 0 run function callyourhorse:horse_teleport/teleport_horse with storage callyourhorse:root
